...
function View4Money() {
  const [items, setItems] = useState([
    { id: 1, value: 5, label: '5元', image: './assets/5.png', placed: false, x: 0, y: 0 },
    { id: 2, value: 10, label: '10元', image: './assets/10.png', placed: false, x: 0, y: 0 },
    { id: 3, value: 2, label: '2元', image: './assets/2.png', placed: false, x: 0, y: 0 },
    { id: 4, value: 1, label: '1元', image: './assets/1.png', placed: false, x: 0, y: 0 },
  ]);
